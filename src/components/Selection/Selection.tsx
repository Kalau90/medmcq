  ...
  return (
    <div className="flex-container">
      <Container className="content">
        ...
        <Divider />
        {notice?.message && <Message color={notice.color as any}><Message.Header><a href='https://survey.au.dk/LinkCollector?key=24AATV69UJ95'>Skal MCQ.AU.DK lukke, ændres eller bruges på en anden måde?</a></Message.Header>{notice.message}</Message>}
